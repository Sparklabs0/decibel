...
export default function LabelUpdateForm(props) {
  ...
  const [labelRecord, setLabelRecord] = React.useState(labelModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Label, idProp)
        : labelModelProp;
      setLabelRecord(record);
    };
    queryData();
  }, [idProp, labelModelProp]);
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || labelModelProp)}
